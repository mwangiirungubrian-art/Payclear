  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="bg-blue-50 px-6 py-28 text-center">
        <p className="text-xs font-semibold text-blue-600 tracking-widest uppercase mb-6">The Global Salary Transparency Platform</p>
        <h1 className="text-5xl font-semibold text-gray-900 leading-tight max-w-2xl mx-auto">
          Every job.<br/>
          <span className="text-blue-600">Every salary.</span><br/>
          No exceptions.
        </h1>
        <p className="mt-6 text-lg text-gray-500 max-w-lg mx-auto">
          No more guessing. No more wasted interviews. Every listing on Luravo shows a real salary range — always.
        </p>
        <div className="mt-10 flex justify-center gap-4 flex-wrap">
          <a href="/jobs" className="bg-blue-600 text-white px-8 py-4 rounded-full text-base font-semibold hover:bg-blue-700">
            Browse Jobs
          </a>
          <a href="/checkout" className="border border-blue-600 text-blue-600 px-8 py-4 rounded-full text-base font-semibold hover:bg-blue-50">
            Post a Job
          </a>
        </div>
      </section>
      ...
      <section className="border-y border-gray-100 py-8 px-6">
        <div className="max-w-4xl mx-auto grid grid-cols-3 divide-x divide-gray-100 text-center">
          <div className="px-6">
            <p className="text-3xl font-semibold text-blue-600">2,400+</p>
            <p className="text-sm text-gray-500 mt-1">jobs with salaries</p>
          </div>
          <div className="px-6">
            <p className="text-3xl font-semibold text-blue-600">18,000+</p>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-semibold text-center text-gray-900 mb-14">How Luravo works</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 border border-gray-100">
              <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-semibold mb-4">1</div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-100">
              <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-semibold mb-4">2</div>
              ...
              <p className="text-blue-600 text-sm font-medium mt-4">No surprises ✓</p>
            </div>
            <div className="bg-white rounded-2xl p-8 border border-gray-100">
              <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-semibold mb-4">3</div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-blue-50 rounded-2xl p-8 text-center">
              <p className="text-4xl font-semibold text-blue-600 mb-2">80%</p>
            ...
            <div className="bg-blue-50 rounded-2xl p-8 text-center">
              <p className="text-4xl font-semibold text-blue-600 mb-2">73%</p>
      ...
      <section className="bg-blue-600 py-20 px-6 text-center">
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          ...
          <a href="/jobs" className="border border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-blue-700">
            Browse Jobs
          </a>
        </div>
      </section>
